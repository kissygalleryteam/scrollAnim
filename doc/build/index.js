 ...
 * @module scrollAnim
 **/
KISSY.add('kg/scrollAnim/2.0.0/index', function (S, Node, DOM, Anim, Base) {
    ...
    S.extend(ScrollAnim, Base, /** @lends ScrollAnim.prototype*/{
        ...
        */
        smoothWheelScroll: function(speed){
            ...
            S.one(document).on('mousewheel', function(ev){
                //平滑滚动
                ev.halt();
                if(scrollAnim){
                    scrollAnim.stop();
                ...
                scrollAnim = Anim(_scrollable,{scrollTop: DOM.scrollTop() - scrollTimes * 100 * ev.deltaY}, 0.5, 'easeOut', function(){
        ...
        */
        smoothKeydownScroll: function(speed){
            ...
            S.one(document).on('keydown', function(ev){
                //平滑滚动
                if(ev.which==38){
                    ev.halt();
                    if(scrollAnim){
                    ...
                    scrollAnim = Anim(_scrollable,{scrollTop: DOM.scrollTop() - scrollTimes * 100}, 0.5, 'easeOut', function(){
                        scrollAnim = undefined;
                        scrollTimes = 1;
                    }).run();
                }
        ...
        */
        scrollLineAnim: function(elem, attr, config, callback){
            ...
            S.one(window).on('scroll', pre_scroll_fn=function(ev){
